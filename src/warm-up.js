...
var vegetables = ['lettuce', 'po-tay-toh', 'ginger', 'cucumber', 'cilantro'];
...
var fruits = ['kiwi', 'grapefruit', 'apple', 'peach', 'pomogranite', 'dragonfruit', 'grapes'];
...
var groceryStore = {
    name: 'Whole Foods',
    isOpen: true,
    address: '247 Evergreen Ln.',
    sqFootageInFeet: 8000,
};
...
groceryStore.location = 'Oklahoma City';